...
class Block {
    constructor(index, timestamp, data, previousHash = '') {
        ...
        this.nonce = 0; // Для Proof of Work
    }
    ...
    // Добавим метод для Proof of Work
...
class Blockchain {
    constructor() {
        ...
        this.difficulty = 2; // Уровень сложности для Proof of Work
        this.miningReward = 100; // Награда за майнинг
    }
    ...
    minePendingTransactions(minerRewardAddress) {
        ...
        this.createTransaction("network", minerRewardAddress, this.miningReward);
